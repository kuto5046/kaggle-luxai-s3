...
class Config:
    ...
    episode_dir: Path = root_dir / "data/42890844/episodes"
    episode_path: Path = root_dir / "data/42890844/episodes.csv"
    feature_dir: Path = root_dir / f"output/feature_store/aDg4b_42890844"
    target_team_name: str = "aDg4b"
    target_sub_ids: list[int] = field(default_factory=lambda: [42890844])
    validation: bool = False

    remove_episodes = [68424787, ]
